...
import { assessContractDeadline, extractContractObligations, prepareContractAction, sendContractNotice, verifyContractObligation } from "./tools.js";

export function createContractObligationsRuntime(): AgentOrchestrator {
  const registry = new ToolRegistry();
  registry.register(extractContractObligations);
